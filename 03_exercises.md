...
```r
breed_rank_all_long <- breed_rank_all %>% 
...
[Link Here](https://github.com/gradymunro/exercise_03/blob/master/03_exercises.Rmd)

## Challenge problem! 

This problem uses the data from the Tidy Tuesday competition this week, `kids`. If you need to refresh your memory on the data, read about it [here](https://github.com/gradymunro/exercise_03). 
